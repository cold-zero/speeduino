...
*/
#define PORT_TYPE \
    uint32_t  // Size of the port variables (Eg inj1_pin_port). Most systems use a byte, but SAMD21 and possibly others
              // are a 32-bit unsigned int
...
#define MAX_TIMER_PERIOD \
    139808  // This is the maximum time, in uS, that the compare channels can run before overflowing. It is typically
            // 65535 * <how long each tick represents>
...
#define DISABLE_BOOST_TIMER(void) \
    {                             \
<macro here>
