...
*/
#define PORT_TYPE \
    uint32_t  // Size of the port variables (Eg inj1_pin_port). Most systems use a byte, but SAMD21 is a 32-bit unsigned
              // int
...
*/
// See :
// https://electronics.stackexchange.com/questions/325159/the-value-of-the-tcc-counter-on-an-atsam-controller-always-reads-as-zero
//  SAME512 Timer channel list:
//  https://user-images.githubusercontent.com/11770912/62131781-2e150b80-b31f-11e9-9970-9a6c2356a17c.png
...
#define uS_TO_TIMER_COMPARE(uS) \
    ((uS * 15) >>               \
     5)  // Converts a given number of uS into the required number of timer ticks until that time has passed.
