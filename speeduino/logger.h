 ...
 * @author Josh Stewart
 *
 * This file contains functions for creating a log file for use with by TunerStudio directly or to be written to an SD
 * card
 *
 */
...
#define LOG_ENTRY_SIZE \
    127 /**< The size of the live data packet. This MUST match ochBlockSize setting in the ini file */
#else
