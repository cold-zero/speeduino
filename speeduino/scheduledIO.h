...
// The following functions are used specifically for the trailing coil on rotary engines. They are separate as they also
// control the switching of the trailing select pin
...
// Macros are used to define how each injector control system functions. These are then called by the master
// openInjectx() function. The DIRECT macros (ie individual pins) are defined below. Others should be defined in their
// relevant acc_x.h file
...
#define openInjector5_DIRECT()             \
    {                                      \
        *inj5_pin_port |= (inj5_pin_mask); \
    }
#define closeInjector5_DIRECT()             \
    {                                       \
        *inj5_pin_port &= ~(inj5_pin_mask); \
    }
#define openInjector6_DIRECT()             \
    {                                      \
        *inj6_pin_port |= (inj6_pin_mask); \
    }
#define closeInjector6_DIRECT()             \
    {                                       \
        *inj6_pin_port &= ~(inj6_pin_mask); \
    }
#define openInjector7_DIRECT()             \
    {                                      \
        *inj7_pin_port |= (inj7_pin_mask); \
    }
#define closeInjector7_DIRECT()             \
    {                                       \
        *inj7_pin_port &= ~(inj7_pin_mask); \
    }
#define openInjector8_DIRECT()             \
    {                                      \
        *inj8_pin_port |= (inj8_pin_mask); \
    }
#define closeInjector8_DIRECT()             \
    {                                       \
        *inj8_pin_port &= ~(inj8_pin_mask); \
    }
...
#define coil1StopCharging_MC33810()      \
    if (configPage4.IgInv == GOING_HIGH) \
        {                                \
            coil1High_MC33810();         \
        }                                \
...
#define coil2StopCharging_MC33810()      \
    if (configPage4.IgInv == GOING_HIGH) \
        {                                \
            coil2High_MC33810();         \
        }                                \
...
#define coil3StopCharging_MC33810()      \
    if (configPage4.IgInv == GOING_HIGH) \
        {                                \
            coil3High_MC33810();         \
        }                                \
...
#define coil4StopCharging_MC33810()      \
    if (configPage4.IgInv == GOING_HIGH) \
        {                                \
            coil4High_MC33810();         \
        }                                \
...
#define coil5StopCharging_MC33810()      \
    if (configPage4.IgInv == GOING_HIGH) \
        {                                \
            coil5High_MC33810();         \
        }                                \
...
#define coil6StopCharging_MC33810()      \
    if (configPage4.IgInv == GOING_HIGH) \
        {                                \
            coil6High_MC33810();         \
        }                                \
...
#define coil7StopCharging_MC33810()      \
    if (configPage4.IgInv == GOING_HIGH) \
        {                                \
            coil7High_MC33810();         \
        }                                \
...
#define coil8StopCharging_MC33810()      \
    if (configPage4.IgInv == GOING_HIGH) \
        {                                \
            coil8High_MC33810();         \
        }                                \
