...
}  // Write 1 to the CHIE (Channel Interrupt Enable) bit of channel 0 Status/Control
...
{
    FTM0_C0SC &= ~FTM_CSC_CHIE;
}  // Write 0 to the CHIE (Channel Interrupt Enable) bit of channel 0 Status/Control
